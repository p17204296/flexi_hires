            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="registrationForm" method="post" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="projectTitle" value="<?= $row->projectTitle; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="form-control" rows="12" cols="100" name="description"> <?= $row->description; ?></textarea>
                        </div>
                    </div>
...
<!--                </div>-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="dueDate" value="<?= $row->dueDate; ?>" placeholder="YYYY-MM-DD" />
                        </div>
                    </div>
