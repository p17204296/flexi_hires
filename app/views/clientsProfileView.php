...
$row=$data['clientTable'];//Freelancer details from table
$row2=$data['postedAdvertsTable'];//Ongoing Project details from table
$row3=$data['prevProjectsTable']; //Completed Project details from table
$row4=$data['hiredTable']; //Completed Project details from table
$row5=$data['prevHiredTable']; //Completed Project details from table
